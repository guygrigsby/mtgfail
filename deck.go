...
func BuildDeck(bulk Bulk, deckList map[string]int, log log15.Logger) (*DeckFile, error) {
	deck := make(map[*Entry]int)
...
func buildStacks(log log15.Logger, stacks ...map[*Entry]int) *DeckFile {
